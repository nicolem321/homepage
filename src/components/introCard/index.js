...
const IntroCard = () => {
    return (
            ...
            <div className="descriptionBlock">
                ...
                on Black-box Decision-based Adversarial Attacks on image classification/recognition models. My current research interest include Machine Learning Applications, Adversarial Machine Learning, and Security, but I am willing to explor other areas for potential projects as well. 
